  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/services/couples-relationship-therapy",
...
export const footerNav: {
  ...
  services: [
    ...
    { label: "Couples Therapy", href: "/services/couples-relationship-therapy" },
  ...
  resources: [
    ...
    { label: "Mental Health Treatment Plans", href: "/services/mental-health-treatment-plans" },
...
export const mobileNav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "NDIS Psychology", href: "/services/ndis-psychology" },
      { label: "Corporate & EAP", href: "/services/corporate-eap" },
      { label: "Workshops", href: "/services/workshops-training" },
      { label: "Treatment Plans", href: "/services/mental-health-treatment-plans" },
    ],
  },
  {
    label: "Conditions",
